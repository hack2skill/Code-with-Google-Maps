                        ...
                        child: Column(
                          children: [
                            ...
                            TextFormField(
                              ...
                              textInputAction: TextInputAction.next,
                              decoration: const InputDecoration(
                                prefixIcon: Icon(Icons.rectangle_outlined),
                            ...
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                hintText: "Number of seats in vehicle",
                              ),
                            ),
                            const SizedBox(
                              height: 20,
                            ...
                            TextFormField(
                              validator: (value) {
                                if (value!.isEmpty) {
                                  return "Fare price cannot be empty";
                                }
                                return null;
                              },
                            ...
                            onPressed: () async {
                              try {
                                ...
                                User user = (await FirebaseAuth.instance
                                    ...
                                    .user!;
                                // save the values
                                sp.phoneNumberDriver(
                                  user: user,
                                  accNo: accNo.text,
                                  phoneNo: phoneController.text,
                                  name: nameController.text,
                                  numberPlate: numberPlate.text,
                                  farePrice: fareController.text,
                                  seatCount: seatCount.text,
                                );
                                // checking whether the driver exists
                                sp.checkDriverExists().then(
                                  (value) async {
                                    if (value == true) {
                                      // Driver exists
                                      await sp
                                          .getDriverDataFromFirestore(sp.uidD)
                                          .then(
                                            (value) => sp
                                                .saveDriverDataToSharedPreferences()
                                                .then(
                                                  (value) => sp
                                                      .setSignInAsDriver()
                                                      .then(
                                      ...
                                      // user does not exist
                                      await sp.saveDriverDataToFirestore().then(
                                            (value) => sp
                                                .saveDriverDataToSharedPreferences()
                                                .then(
                                                  (value) => sp
