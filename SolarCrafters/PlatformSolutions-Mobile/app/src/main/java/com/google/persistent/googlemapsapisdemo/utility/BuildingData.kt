...
object BuildingData {
    ...
    fun getLocationDataList(): MutableList<LocationDataClass> {
        ...
        listOfLocation.add(LocationDataClass(32.79626463265465, -117.01002549380065, "6376 Lake Arrowhead Drive, San Diego, CA 92119 Lake Murray, San Diego, California, United States", true))
